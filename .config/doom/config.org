...
;; TODO: make a version of this function that let you pick a theme and do everything,   []
...
(defun laluxx-doom-wal ()
  ...
  ;; (shell-command "python3 /home/l/xos/pywal-scripts/xmonad-dark-wal.py") ;; light theme
